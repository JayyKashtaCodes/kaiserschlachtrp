...
-- Base Cigarette SWEP by Mordestein (based on Vape SWEP by Swamp Onions)

-- WW2 Cigarette SWEP by [W-G] Paul (based on Cigarette SWEP by Mordestein, which is also based on Vape SWEP by Swamp Onions)
...
SWEP.Instructions = "Hold LMB: Smoke, release to exhale RMB: Light it up"

SWEP.PrintName = "Cigar"

SWEP.IconLetter	= ""
SWEP.Category = "KSR - Smoking"
SWEP.Slot = 1
SWEP.SlotPos = 0
...
SWEP.ViewModel = "models/customhq/tobaccofarm/cigar.mdl"
SWEP.WorldModel = "models/customhq/tobaccofarm/cigar.mdl"
SWEP.Spawnable = true
...
function SWEP:Initialize()
	...
	if !self.CigaInitialized then
		...
		self.VElements = {
			["ciga"] = { type = "Model", model = self.ViewModel, bone = "ValveBiped.Bip01_Spine4", rel = "", pos = Vector(-6.5, -2.5, 22.377), angle = Angle(11.039, 0, 0), size = Vector(0.8,.8,.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
		}
		...
		self.ViewModelBoneMods = {
			["ValveBiped.Bip01_L_Finger1"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(13.334, -12.223, -32.223) },
...
function SWEP:SecondaryAttack()
	self:EmitSound("lighter.wav", 80, 100, 1)
	if SERVER then
