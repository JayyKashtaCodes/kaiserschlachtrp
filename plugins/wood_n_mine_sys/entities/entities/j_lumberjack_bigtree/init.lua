...
util.AddNetworkString("WoodBigTree_Spawn")
...
function ENT:Initialize()
	...
	self:SetModel(modelsTree[ math.random( #modelsTree ) ])
...
function ENT:CutTree(ply, dmg)
	...
	if (self.health <= 0) then
		...
		ix.item.Spawn("wood_log" ,self:GetPos() + Vector(0,0,144), function(item, entity)
