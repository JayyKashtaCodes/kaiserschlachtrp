...
ENT.PrintName = "Jail History NPC"
...
if SERVER then
    ...
    function ENT:Initialize()
        self:SetModel("models/ksr/policesr/nco_04.mdl")
    ...
    -- Match Banking NPC physics setup
    ...
    -- Same animation logic as Banking NPC
...
if CLIENT then
    function ENT:Draw()
        ...
        cam.Start3D2D(pos, Angle(0, ang.y - 90, 90), 0.25)
            draw.SimpleText("View Jail History", "DermaLarge", 0, 0, Color(255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
        cam.End3D2D()
    end

    net.Receive("OpenJailHistoryMenu", function()
        PLUGIN:OpenJailHistory()
    end)
end
