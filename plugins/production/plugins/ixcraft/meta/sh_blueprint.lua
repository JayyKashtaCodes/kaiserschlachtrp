...
-- replace code in meta/sh_blueprint.lua

local PLUGIN = PLUGIN
PLUGIN.meta = PLUGIN.meta or {}

local BLUEPRINT = PLUGIN.meta.blueprint or {}
BLUEPRINT.__index = BLUEPRINT
BLUEPRINT.name = "undefined"
BLUEPRINT.description = "undefined"
BLUEPRINT.uniqueID = "undefined"
BLUEPRINT.category = "Crafting"
BLUEPRINT.craftTime = 0

function BLUEPRINT:GetName()
	return self.name
end

function BLUEPRINT:GetDescription()
	return self.description
end

function BLUEPRINT:GetSkin()
	return self.skin
end

function BLUEPRINT:GetModel()
	return self.model
end

function BLUEPRINT:GetCraftTime()
	return self.craftTime
end

function BLUEPRINT:PreHook(name, func)
...
function BLUEPRINT:PostHook(name, func)
...
function BLUEPRINT:OnCanSee(client)
...
function BLUEPRINT:OnCanCraft(client)
	local character = client:GetCharacter()
...
if (SERVER) then
	function BLUEPRINT:OnCraft(client)
...
PLUGIN.meta.blueprint = BLUEPRINT
